<template>
  <div class="user-info">
      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="工号">
            <el-input v-model="userInfo.employeeId" class="inputW" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row class="inline-info">
        <el-col :span="12">
          <el-form-item label="姓名">
            <el-input v-model="userInfo.name" class="inputW" />
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item label="部门">
            <el-input v-model="userInfo.orgName" class="inputW" />
          </el-form-item>
        </el-col>
      </el-row>
      <!--手机 聘用形式  -->
    ...
    <!-- 基础信息 -->
    <div>          <el-alert
      title="以下表单信息请根据企业自行扩展,此处仅举例,供参考不做后台数据交互"
      type="error"
    /></div>
    <el-form label-width="220px">
      <div class="block">
